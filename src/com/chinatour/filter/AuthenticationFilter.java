...
import com.chinatour.AuthenticationToken;
import com.chinatour.service.RSAService;
...
public class AuthenticationFilter extends FormAuthenticationFilter {
    ...
    /**
     * 获得用户角色（admin还是PeerUser）
     * */
    /*protected String getUserRole(ServletRequest servletRequest) {
        String captchaId = WebUtils.getCleanParam(servletRequest, captchaIdParam);
        if (captchaId == null) {
            captchaId = ((HttpServletRequest) servletRequest).getSession().getId();
        }
