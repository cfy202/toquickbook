...
public class Setting implements Serializable {
     ...
     * 图片上传路径
     */
    private String enquiryUploadPath;
    /**
     * 产品图片上传路径
     */
     ...
     * 同行Logo上传路径
     */
    private String peerUserLogoPath;
    /**
     * 同行系统首页新闻图片上传路径
     */
    private String newsForAgencyPath;
    
	/**
     * Flash上传路径
     */
    private String shareUploadPath;

    /**
     * 媒体上传路径
     */
    private String appendixUploadPath;

    /**
     * 文件上传路径
     */
    private String tourQuoteUploadPath;
     ...
     * @return 询价上传路径
     */
    public String getEnquiryUploadPath() {
        return enquiryUploadPath;
    }

    /**
     * 设置询价上传路径
     *
     * @param enquiryUploadPath 询价上传路径
     */
    public void setEnquiryUploadPath(String enquiryUploadPath) {
        if (enquiryUploadPath != null) {
            if (!enquiryUploadPath.startsWith("/")) {
            	enquiryUploadPath = "/" + enquiryUploadPath;
            }
            if (!enquiryUploadPath.endsWith("/")) {
            	enquiryUploadPath += "/";
            }
        }
        this.enquiryUploadPath = enquiryUploadPath;
    }
     ...
     * @return 共享上传路径
     */
    public String getShareUploadPath() {
        return shareUploadPath;
    }

    /**
     * 设置共享上传路径
     *
     * @param shareUploadPath 共享上传路径
     */
    public void setShareUploadPath(String shareUploadPath) {
        if (shareUploadPath != null) {
            if (!shareUploadPath.startsWith("/")) {
            	shareUploadPath = "/" + shareUploadPath;
            }
            if (!shareUploadPath.endsWith("/")) {
            	shareUploadPath += "/";
            }
        }
        this.shareUploadPath = shareUploadPath;
    }
     ...
     * 设置生成pdf文件临时路径
     *
     * @param tempPDFPath pdf文件临时路径
     */
    public void setTempPDFPath(String tempPDFPath) {
        if (tempPDFPath != null) {
            if (!tempPDFPath.startsWith("/")) {
            	tempPDFPath = "/" + tempPDFPath;
            }
            if (!tempPDFPath.endsWith("/")) {
            	tempPDFPath += "/";
            }
        }
     ...
     * @return 文件上传路径
     */
    public String getTourQuoteUploadPath() {
        return tourQuoteUploadPath;
    }

    /**
     * 设置文件上传路径
     *
     * @param tourQuoteUploadPath 文件上传路径
     */
    public void setTourQuoteUploadPath(String tourQuoteUploadPath) {
        if (tourQuoteUploadPath != null) {
            if (!tourQuoteUploadPath.startsWith("/")) {
            	tourQuoteUploadPath = "/" + tourQuoteUploadPath;
            }
            if (!tourQuoteUploadPath.endsWith("/")) {
            	tourQuoteUploadPath += "/";
            }
        }
        this.tourQuoteUploadPath = tourQuoteUploadPath;
    }
     ...
     * @return 站内信上传路径
     */
    public String getAppendixUploadPath() {
        return appendixUploadPath;
    }

    /**
     * 设置媒体上传路径
     *
     * @param AppendixUploadPath 媒体上传路径
     */
    public void setAppendixUploadPath(String appendixUploadPath) {
        if (appendixUploadPath != null) {
            if (!appendixUploadPath.startsWith("/")) {
            	appendixUploadPath = "/" + appendixUploadPath;
            }
            if (!appendixUploadPath.endsWith("/")) {
            	appendixUploadPath += "/";
            }
        }
        this.appendixUploadPath = appendixUploadPath;
    }
     ...
     *
     */
    public String getProductImageUploadPath() {
		return productImageUploadPath;
	}
    /**
     * 设置产品图片上传路径
     *
     * @param productImageUploadPath 媒体上传路径
     */
	public void setProductImageUploadPath(String productImageUploadPath) {
		if (productImageUploadPath != null) {
            if (!productImageUploadPath.startsWith("/")) {
            	productImageUploadPath = "/" + productImageUploadPath;
            }
            if (!productImageUploadPath.endsWith("/")) {
            	productImageUploadPath += "/";
            }
        }
		this.productImageUploadPath = productImageUploadPath;
	}

	public String getNewsForAgencyPath() {
		return newsForAgencyPath;
	}

	public void setNewsForAgencyPath(String newsForAgencyPath) {
		if (newsForAgencyPath != null) {
            if (!newsForAgencyPath.startsWith("/")) {
            	newsForAgencyPath = "/" + newsForAgencyPath;
            }
            if (!newsForAgencyPath.endsWith("/")) {
            	newsForAgencyPath += "/";
            }
        }
		this.newsForAgencyPath = newsForAgencyPath;
	}

	public String getPeerUserLogoPath() {
		return peerUserLogoPath;
	}

	public void setPeerUserLogoPath(String peerUserLogoPath) {
		if (peerUserLogoPath != null) {
            if (!peerUserLogoPath.startsWith("/")) {
            	peerUserLogoPath = "/" + peerUserLogoPath;
            }
            if (!peerUserLogoPath.endsWith("/")) {
            	peerUserLogoPath += "/";
            }
        }
		this.peerUserLogoPath = peerUserLogoPath;
	}
