...
<div class="md-modal colored-header custom-width md-effect-9" id="form-primary">
	<div class="md-content">
		...
		<form id="sysForm" method="post" action="[@spring.url '/admin/orders/synchronousForTourOrder.jhtml'/]">
...
<div class="md-modal colored-header custom-width md-effect-9" id="form-primary1">
	<div class="md-content">
		...
		<form id="sysForOneForm" method="post" action="[@spring.url '/admin/orders/synchronousForTourOrder.jhtml'/]">
			<div class="modal-body form">
				<div class="text-center">
					<h4>Are you sure to synchronous?</h4>
                ...
                { "data": "isSuccess",
                	"render" : function(data, type, row) {
					  	switch(data){
					  		...
					  		break;
					  		case 3 : return '<i title="DisApproved" class="fa fa-times"></i>';
					  		break;
					  		default: return '';
					  	}
					}},
