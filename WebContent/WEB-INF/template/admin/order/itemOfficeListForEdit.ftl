...
<div class="md-modal colored-header custom-width md-effect-9" id="form-primary">
	<div class="md-content">
		...
		<form id="sysForm" method="post" action="[@spring.url '/admin/orders/synchronousForEditOrder.jhtml'/]">
...
<div class="md-modal colored-header custom-width md-effect-9" id="form-primary1">
	<div class="md-content">
		...
		<form id="sysForOneForm" method="post" action="[@spring.url '/admin/orders/synchronousForEditOrder.jhtml'/]">
			<div class="modal-body form">
				<div class="text-center">
					<h4>Are you sure to synchronous?</h4>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#datatable2').dataTable({
            ...
            "ajax": {
                url: "[@spring.url '/admin/orders/itemOfficeListForEdit.jhtml'/]",
                type: "POST",
                "data": function ( data ) {
