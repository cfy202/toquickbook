!function (a) {
    ...
    var c = {bMac: navigator.appVersion.indexOf("Mac") > -1, bMSIE: navigator.userAgent.indexOf("MSIE") > -1, bFF: navigator.userAgent.indexOf("Firefox") > -1, bCodeMirror: !!b}, d = function () {
        ...
        this.stylePara = function (b, c) {
            ...
            if (i && i.style["line-height"])e["line-height"] = i.style.lineHeight; else {
        ...
        this.showImageDialog = function (b, c, d, e) {
            var f = b.find(".note-image-dialog"), g = b.find(".note-image-input"), h = b.find(".note-image-url"), i = b.find(".note-image-btn");
            ...
            var d = a.find(".note-video-dialog"), e = d.find(".note-video-url"), f = d.find(".note-video-btn");
        ...
        var d = new k, e = new l, g = new m, i = new n, j = new o, p = {BACKSPACE: 8, TAB: 9, ENTER: 13, SPACE: 32, NUM0: 48, NUM1: 49, NUM6: 54, NUM7: 55, NUM8: 56, B: 66, E: 69, I: 73, J: 74, K: 75, L: 76, R: 82, S: 83, U: 85, Y: 89, Z: 90, SLASH: 191, LEFTBRACKET: 219, BACKSLACH: 220, RIGHTBRACKET: 221}, q = function (b) {
            ...
            if (f === p.TAB && h.editable().data("tabsize"))d.tab(h.editable()); else if (b && (e && f === p.Z || f === p.Y))d.redo(h.editable()); else if (b && f === p.Z)d.undo(h.editable()); else if (b && f === p.B)d.bold(h.editable()); else if (b && f === p.I)d.italic(h.editable()); else if (b && f === p.U)d.underline(h.editable()); else if (b && e && f === p.S)d.strikethrough(h.editable()); else if (b && f === p.BACKSLACH)d.removeFormat(h.editable()); else if (b && f === p.K)h.editable(), d.setLinkDialog(h.editable(), function (a, b) {
                j.showLinkDialog(h.dialog(), a, b)
            }); else if (b && f === p.SLASH)j.showHelpDialog(h.dialog()); else if (b && e && f === p.L)d.justifyLeft(h.editable()); else if (b && e && f === p.E)d.justifyCenter(h.editable()); else if (b && e && f === p.R)d.justifyRight(h.editable()); else if (b && e && f === p.J)d.justifyFull(h.editable()); else if (b && e && f === p.NUM7)d.insertUnorderedList(h.editable()); else if (b && e && f === p.NUM8)d.insertOrderedList(h.editable()); else if (b && f === p.LEFTBRACKET)d.outdent(h.editable()); else if (b && f === p.RIGHTBRACKET)d.indent(h.editable()); else if (b && f === p.NUM0)d.formatBlock(h.editable(), "P"); else if (b && p.NUM1 <= f && f <= p.NUM6) {
            ...
            if (h.length > 0) {
                var i, k = h.attr("data-event"), l = h.attr("data-value"), m = q(g.target), n = m.editor(), o = m.toolbar(), p = m.dialog(), r = m.editable(), u = m.codable();
                if (-1 !== a.inArray(k, ["resize", "floatMe"])) {
                    var w = m.handle(), x = w.find(".note-control-selection");
                    i = x.data("target")
                }
                if (d[k] && (r.trigger("focus"), d[k](r, l, i)), -1 !== a.inArray(k, ["backColor", "foreColor"]))e.updateRecentColor(h[0], k, l); else if ("showLinkDialog" === k)r.focus(), d.setLinkDialog(r, function (a, b) {
                ...
                }); else if ("showHelpDialog" === k)j.showHelpDialog(p); else if ("fullscreen" === k) {
                    n.toggleClass("fullscreen");
                    var y = function () {
                        var b = a(window).height() - o.outerHeight();
                        r.css("height", b)
                    }, z = n.hasClass("fullscreen");
                    if (z)r.data("orgHeight", r.css("height")), a(window).resize(y).trigger("resize"); else {
                    ...
                    if (B) {
                        if (u.val(r.html()), u.height(r.height()), e.disable(o), u.focus(), c.bCodeMirror) {
                            var C = b.fromTextArea(u[0], a.extend({mode: "text/html", lineNumbers: !0}, n.data("options").codemirror));
                            C.setSize(null, r.outerHeight()), C.autoFormatRange && C.autoFormatRange({line: 0, ch: 0}, {line: C.lineCount(), ch: C.getTextArea().value.length}), u.data("cmEditor", C)
                        }
        ...
        this.createLayout = function (c, i) {
            var k = i.height, l = i.tabsize, m = i.toolbar;
        ...
        var t = this.layoutInfoFromHolder = function (a) {
            var b = a.next();
            if (b.hasClass("note-editor"))return{editor: b, dropzone: b.find(".note-dropzone"), toolbar: b.find(".note-toolbar"), editable: b.find(".note-editable"), codable: b.find(".note-codable"), statusbar: b.find(".note-statusbar"), popover: b.find(".note-popover"), handle: b.find(".note-handle"), dialog: b.find(".note-dialog")}
        };
    ...
    a.fn.extend({summernote: function (b) {
        if (b = a.extend({toolbar: [
            ...
            ["help", ["help"]]
        ], locale: "en-US"}, b), this.each(function (c, d) {
            var e = a(d);
            s.createLayout(e, b);
        ...
        this.each(function (b, c) {
            var d = a(c), e = s.layoutInfoFromHolder(d);
