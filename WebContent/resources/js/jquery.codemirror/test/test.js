...
testCM("everythingFolded", function (cm) {
    addDoc(cm, 2, 2);
    function enterPress() {
        cm.triggerOnKeyDown({type: "keydown", keyCode: 13, preventDefault: function () {
...
testCM("extraKeys", function (cm) {
    ...
    function fakeKey(expected, code, props) {
        ...
        var e = {type: "keydown", keyCode: code, preventDefault: function () {
        }, stopPropagation: function () {
        }};
    ...
    cm.setOption("extraKeys", {"Shift-X": function () {
        outcome = "sx";
    },
        "X": function () {
            outcome = "x";
...
testCM("findPosH", function (cm) {
    forEach([
        ...
        {from: Pos(1, 15), to: Pos(2, 0), by: 50, hitSide: true}
    ], function (t) {
