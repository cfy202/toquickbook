...
(function () {
    ...
    var a = this, b = a._, c = {}, d = Array.prototype, e = Object.prototype, f = d.slice, g = d.unshift, h = e.toString, i = e.hasOwnProperty, j = d.forEach, k = d.map, l = d.reduce, m = d.reduceRight, n = d.filter, o = d.every, p = d.some, q = d.indexOf, r = d.lastIndexOf;
    e = Array.isArray;
    var s = Object.keys, t = function (a) {
        return new y(a)
    };
    typeof module != "undefined" && module.exports ? (module.exports = t, t._ = t) : a._ = t, t.VERSION = "1.1.4";
    var u = t.each = t.forEach = function (a, b, d) {
        if (a != null)if (j && a.forEach === j)a.forEach(b, d); else if (t.isNumber(a.length)) {
    ...
    t.include = t.contains = function (a, b) {
        ...
        var d = f.call(arguments), e = d.length <= 1;
        ...
        var c = {};
        return b = b || t.identity, function () {
    ...
    t.uniqueId = function (a) {
        var b = x++;
        return a ? a + b : b
    }, t.templateSettings = {evaluate: /<%([\s\S]+?)%>/g, interpolate: /<%=([\s\S]+?)%>/g}, t.template = function (a, b) {
        ...
        }).replace(/\r/g, "\\r").replace(/\n/g, "\\n").replace(/\t/g, "\\t") + "');}return __p.join('');", c = Function("obj", c), b ? c(b) : c
    };
    var y = function (a) {
        this._wrapped = a
    };
    ...
    function m(a) {
        ...
        function q(a) {
            var b = !1, c = !1, e = !1, f = a == ".", g = o(function (g, h) {
        ...
        function x() {
            return e(), N("Unterminated multiline comment", function () {
                var a = j("*/", !0), b = P.text.substring(P.pos, a);
        ...
        function B() {
            var a = !1, c = "", d;
            while ((d = b()) != null)if (!a)if (d == "\\")a = !0, e(); else {
                if (!h(d))break;
                c += e()
    ...
    function o(a, b, c) {
        ...
        function A(a) {
            return c ? function () {
                var b = jb.token, c = a.apply(this, arguments);
        ...
        var jb = {input: typeof a == "string" ? m(a, !0) : a, token: null, prev: null, peeked: null, in_function: 0, in_loop: 0, labels: []};
        jb.token = f();
        var kb = A(function () {
            ...
            return a && !b && j(), r("("), x(a ? "defun" : "function", b, function (a, b) {
    ...
    var K = {}, L = r(["typeof", "void", "delete", "--", "++", "!", "~", "-", "+"]), M = r(["--", "++"]), N = function (a, b, c) {
        ...
        ["+", "-"],
        ["*", "/", "%"]
    ], {}), P = r(["for", "do", "while", "switch"]), Q = r(["atom", "num", "string", "regexp", "name"]);
    ...
    (function (a) {
        a.tokenizer = m, a.parse = o, a.slice = s, a.curry = p, a.member = u, a.array_to_hash = r, a.PRECEDENCE = O, a.KEYWORDS_ATOM = z, a.RESERVED_WORDS = x, a.KEYWORDS = w, a.ATOMIC_START_TOKEN = Q, a.OPERATORS = E, a.is_alphanumeric_char = d, a.set_logger = function (a) {
            R = a
        }
    })(S), a.parsejs = S
}(this), function (a) {
    function b() {
        ...
        var f = {string: function (a) {
            ...
            return[this[0], c(a), I(b, function (a) {
    ...
    function d(a) {
        ...
        function g(a, b, c) {
            var f = this[0] == "defun";
            return[this[0], f ? e(a, "defun") : a, b, d(function () {
                return f || e(a, "lambda"), I(b, function (a) {
                    e(a, "arg")
                }), I(c, l)
            })]
        }
        ...
        var j = null, k = b(), l = k.walk, m = [];
        return d(function () {
            function b(a, c) {
                for (c = a.children.length; --c >= 0;)b(a.children[c]);
                for (c in a.refs)if (x(a.refs, c))for (var d = a.has(c), e = a; e; e = e.parent) {
                    e.refs[c] = d;
                    if (e === d)break
                }
            }

            var c = k.with_walkers({"function": g, defun: g, label: function (a, b) {
                j.labels.define(a)
            }, "break": i, "continue": i, "with": function (a, b) {
    ...
    function e(a, c) {
        ...
        var k = b(), l = k.walk, m;
        return c = c || {}, k.with_walkers({"function": g, defun: function () {
        ...
        }, "break": j, "continue": j, "var": i, "const": i, name: function (a) {
    ...
    function m(a) {
        function c(a) {
            ...
            for (var b = 0; b < a.length; ++b) {
                ...
                var e = g(d[2]);
                if (!h(e))continue;
                var f = g(d[1]), i = c(a.slice(b + 1)), j = i.length == 1 ? i[0] : ["block", i];
                return a.slice(0, b).concat([
                    [d[0], f, e, j]
                ])
            }
            return a
    ...
    function o(a) {
        function c(a, b) {
            var c = i;
            i = b, a = I(a, h);
            var d = {}, e = I(b.names, function (a, c) {
                return a != "var" ? I.skip : b.references(c) ? (d[c] = !0, [c]) : I.skip
            });
            return e.length > 0 && (n(["block", a], function (a, b, c, f) {
        ...
        var g = b(), h = g.walk, i;
        return g.with_walkers({"function": function (a, b, d) {
    ...
    function p(a, c) {
        function d(a) {
            ...
            switch (a[0]) {
                ...
                case"binary":
                    var e = a[1], g = a[2], h = a[3];
                    if (!c.keep_comps)switch (e) {
                        case"<=":
                            return["binary", ">", g, h];
                        case"<":
                            return["binary", ">=", g, h];
        ...
        function n(a, b) {
            return a = I(a, u), a = _(a).reduce(function (a, b) {
                return b[0] == "block" ? b[1] && a.push.apply(a, b[1]) : a.push(b), a
            }, []), a = function (b, c) {
                return _(a).forEach(function (a) {
                    c && (a[0] == "var" && c[0] == "var" || a[0] == "const" && c[0] == "const") ? c[1] = c[1].concat(a[1]) : (b.push(a), c = a)
                }), b
            }([]), c.dead_code && (a = function (b, d) {
                return _(a).forEach(function (a) {
                    d ? a[0] == "function" || a[0] == "defun" ? b.push(a) : a[0] == "var" || a[0] == "const" ? (c.no_warnings || E("Variables declared in unreachable code"), a[1] = I(a[1], function (a) {
                        return a[1] && !c.no_warnings && l(["assign", !0, ["name", a[0]], a[1]]), [a[0]]
                    }), b.push(a)) : c.no_warnings || l(a) : (b.push(a), A(a[0], ["return", "throw", "break", "continue"]) && (d = !0))
                }), b
            }([])), c.make_seqs && (a = function (b, c) {
                return _(a).forEach(function (a) {
        ...
        function q(a, b, c) {
            a = u(a), b = u(b), c = u(c), j(b) ? (a = d(a), b = c, c = null) : j(c) ? c = null : function () {
                var e = s(a), f = d(a), g = s(f);
            ...
            var g = ["if", a, b, c];
            return b[0] == "if" && j(b[3]) && j(c) ? g = f(g, u(["if", ["binary", "&&", a, b[1]], b[2]])) : b[0] == "stat" ? c ? c[0] == "stat" ? g = f(g, ["stat", e(a, b[1], c[1])]) : h(c) && (g = p(a, b, c)) : g = f(g, ["stat", e(a, b[1])]) : c && b[0] == c[0] && (b[0] == "return" || b[0] == "throw") && b[1] && c[1] ? g = f(g, [b[0], e(a, b[1], c[1])]) : c && h(b) ? (g = [
                ["if", a, b]
            ], c[0] == "block" ? c[1] && (g = g.concat(c[1])) : g.push(c), g = u(["block", g])) : b && h(c) && (g = p(a, b, c)), g
        }
        ...
        var t = b(), u = t.walk;
        return t.with_walkers({sub: function (a, b) {
            if (b[0] == "string") {
                var c = b[1];
                if (w(c))return["dot", u(a), c];
                if (/^[1-9][0-9]*$/.test(c) || c === "0")return["sub", u(a), ["num", parseInt(c, 10)]]
            }
        }, "if": o, toplevel: function (a) {
            return["toplevel", n(a)]
        }, "switch": function (a, b) {
            var c = b.length - 1;
            return["switch", u(a), I(b, function (a, b) {
                var d = n(a[1]);
                if (b == c && d.length > 0) {
                    var e = d[d.length - 1];
                    e[0] == "break" && !e[1] && d.pop()
        ...
        }, "function": k, defun: k, block: function (a) {
            if (a)return g(["block", n(a)])
        }, binary: function (a, b, c) {
            return F(["binary", a, u(b), u(c)], function (a) {
                return f(u(a), this)
            }, function () {
                return function () {
                    if (a != "==" && a != "!=")return;
            ...
            return a == "!" && (c = f(c, d(b))), F(c, function (a, b) {
                return u(a)
            }, function () {
                return c
            })
    ...
    function q(a, b) {
        ...
        return a = a.replace(/[\\\b\f\n\r\t\x22\x27\u2028\u2029\0]/g, function (a) {
            ...
            return a
        }), b && (a = r(a)), c > d ? "'" + a.replace(/\x27/g, "\\'") + "'" : '"' + a.replace(/\x22/g, '\\"') + '"'
    }
    ...
    function s(a, c) {
        ...
        function m(a) {
            if (a[0] == "function" || a[0] == "object") {
                var b = z(R.stack()), c = b.pop(), d = b.pop();
                while (d) {
        ...
        function o(a) {
            ...
            for (; ;) {
                ...
                if (c == "if") {
                    ...
                    b = b[3]
                } else if (c == "while" || c == "do")b = b[2]; else {
        ...
        function E(a) {
            return a ? a.length == 0 ? "{}" : "{" + L + g(function () {
                return t(a).join(L)
            }) + L + f("}") : ";"
        }
        ...
        var J = !!c.beautify, K = 0, L = J ? "\n" : "", Q = J ? " " : "", R = b(), S = R.walk;
        return R.with_walkers({string: d, num: n, name: e, "debugger": function () {
            return"debugger"
        }, toplevel: function (a) {
            return t(a).join(L + L)
        }, splice: function (a) {
            var b = R.parent();
            return x(H, b) ? E.apply(this, arguments) : I(t(a, !0), function (a, b) {
                return b > 0 ? f(a) : a
            }).join(L)
            ...
            return c = c.length > 0 ? "(" + i(I(c, function (a) {
                return k(a, "seq")
            })) + ")" : "", h(["new", k(a, "seq", "binary", "conditional", "assign", function (a) {
                var c = b(), d = {};
                try {
                    c.with_walkers({call: function () {
                        throw d
                    }, "function": function () {
                        return this
                    }}, function () {
            ...
            var c = S(a);
            return c.charAt(0) != "(" && m(a) && (c = "(" + c + ")"), c + "(" + i(I(b, function (a) {
                return k(a, "seq")
            })) + ")"
            ...
            return a.length == 0 ? "[]" : h(["[", i(I(a, function (b, c) {
    ...
    var y = a.parsejs, z = y.slice, A = y.member, B = y.PRECEDENCE, C = y.OPERATORS, D = function () {
        var a = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ$_0123456789";
        return function (b) {
            var c = "", d = 54;
            do c += a.charAt(b % d), b = Math.floor(b / d), d = 64; while (b > 0);
            return c
        }
    }();
    ...
    }(), G = y.array_to_hash(["name", "array", "object", "string", "dot", "sub", "call", "regexp", "defun"]), H = y.array_to_hash(["if", "while", "do", "for", "for-in", "with"]), I;
    (function () {
        function a(a) {
            this.v = a
        }
        ...
        I = function (d, e, f) {
            ...
            var h = [], i = [], j;
            if (d instanceof Array)for (j = 0; j < d.length; ++j)g(); else for (j in d)x(d, j) && g();
            return i.concat(h)
        }, I.at_top = function (b) {
            return new a(b)
        }, I.splice = function (a) {
    ...
    var J = {};
    (function (a) {
        a.ast_walker = b, a.ast_mangle = e, a.ast_squeeze = p, a.ast_lift_variables = o, a.gen_code = s, a.ast_add_scope = d, a.set_logger = function (a) {
            E = a
        }, a.make_string = q, a.split_lines = t, a.MAP = I
    })(J), a.process = J
}(this), function (a) {
    function b(a) {
        function b(a, b) {
        ...
        var e = d.ast_walker(), f = e.walk, i;
        return e.with_walkers({toplevel: function (a) {
    ...
    var c = a.parsejs, d = a.process, e = c.slice, f = c.member, g = c.curry, h = d.MAP, i = c.PRECEDENCE, j = c.OPERATORS, k = {};
    (function (a) {
        a.ast_squeeze_more = b
    })(k), a.process.ast_squeeze_more = k.ast_squeeze_more
}(this), function (a) {
    a.uglify = function (b, c) {
        ...
        var h = {parser: a.parsejs, uglify: a.process}, i = h.parser, j = h.uglify;
        j.set_logger(function (a) {
        });
        var k = {ast: !1, mangle: !0, mangle_toplevel: !1, squeeze: !0, make_seqs: !0, dead_code: !0, beautify: !1, verbose: !1, show_copyright: !0, out_same_file: !1, max_line_length: 32768, extra: !1, unsafe: !1, beautify_options: {indent_level: 4, indent_start: 0, quote_keys: !1, space_colon: !1}, output: !0}, l = c, m;
        a:while (l.length > 0) {
            var n = l.shift();
            switch (n) {
                case"-b":
